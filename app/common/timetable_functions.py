...
def is_free_time(teacher_proposal, student_slot):
    return (
        student_slot["beginning"] <= teacher_proposal["beginning"]
...
"""
    def is_free_student(teacher_proposal,student):
        for student_slot in student["slots"]:
            return is_free_time(teacher_proposal,student_slot) and teacher_proposal["activity"] in student["likings"]:
"""
        ...
        for proposal in teacher["proposals"]:
            ...
            if students != []:
                for student in students:
                    if (
                        proposal["activity"] in student["likings"]
                        and proposal_slots > 0
                    ):
                                    ...
                                    student["slots"].append(
                                        {
                                            ...
                                            "end": proposal["beginning"],
                                        }
                                    )
                                if slot["end"] > proposal["end"]:
                                    student["slots"].append(
                                        {
                                            "beginning": proposal["end"],
                                            "end": slot["end"],
                                        }
                                    )
                                proposal_slots -= 1
...
if __name__ == "__main__":
    ...
    teacher_proposal_1 = {
        "activity": "tennis",
        "beginning": teacher_beginning_time_1,
        "end": teacher_ending_time_1,
        "number_of_slots": 2,
    }
    teacher_proposal_2 = {
        "activity": "tennis",
        "beginning": teacher_beginning_time_2,
